...
public class SearchByfilters extends AppCompatActivity {
    ...
    private void addNewUlam() {
        ...
        ulamArrayList.add(new ulam(500, 350, "קריית גת",R.drawable.aatsula,0));
        ulamArrayList.add(new ulam(300, 300, "יבנה",R.drawable.dereh_ayaar,0));
        ulamArrayList.add(new ulam(500, 290, "אילת",R.drawable.emilia,0));
        ulamArrayList.add(new ulam(270, 600, "גן יבנה",R.drawable.gany_aysvi,0));
        ulamArrayList.add(new ulam(500, 34, "אשקלון",R.drawable.venetsia,0));
